...
import { Button, Checkbox, Heading, ReactLogo, Text, TextInput } from './components';
  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
      ...
      <form className="flex flex-col items-stretch w-full max-w-sm mt-10 gap-4">
        ...
        <label htmlFor="password" className="flex flex-col gap-3">
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type="password" id="password" placeholder="Digite seu e-mail" />
          </TextInput.Root>
        </label>
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        ...
        <Text asChild size="sm"><a href="" className="text-gray-400 underline transition-colors hover:text-gray-200">Não possui conta? Crie uma agora!</a></Text>
      </footer>
    </div>
  );
}
